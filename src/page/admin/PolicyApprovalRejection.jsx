    ...
    const fetchPolicies = async () => {
      try {
        ...
        if (response.status === 200) {
          ...
          const processingPolicies = policies.filter(
            (policy) => policy.policy_status === "processing"
          )
          const rejectedPolicies = policies.filter(
            (policy) => policy.policy_status === "rejected"
          )
...
export default PolicyApprovalRejection
